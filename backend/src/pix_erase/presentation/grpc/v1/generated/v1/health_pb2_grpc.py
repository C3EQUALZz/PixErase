...
from pix_erase.presentation.grpc.v1.generated.v1 import health_pb2 as v1_dot_health__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in v1/health_pb2_grpc.py depends on'
...
class HealthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary(
                '/pix_erase.v1.HealthService/Check',
...
def add_HealthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pix_erase.v1.HealthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pix_erase.v1.HealthService', rpc_method_handlers)
