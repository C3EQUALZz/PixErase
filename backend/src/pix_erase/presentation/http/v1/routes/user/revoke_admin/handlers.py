...
from pix_erase.application.commands.user.revoke_admin_by_id import RevokeAdminByIDCommand, RevokeAdminByIDCommandHandler
...
async def revoke_admin_by_id_handler(
    user_id: Annotated[UUID, UserIDPathParameter], interactor: FromDishka[RevokeAdminByIDCommandHandler]
) -> None:
