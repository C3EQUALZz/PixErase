...
compress_image_router: Final[APIRouter] = APIRouter(route_class=DishkaRoute, tags=["Image"])
...
async def compress_image_handler(
    ...
    command: CompressImageCommand = CompressImageCommand(image_id=image_id, quality=request_schema.quality)
